<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :summary-method="(param) => getSummaries2(param, totalKeys,zongji)" show-summary
      ...
      <el-table-column show-overflow-tooltip label="开证申请人" align="center" min-width="130" prop="drawer">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_1757265915323351000" :value="scope.row.drawer" />
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip label="收益人" min-width="130" align="center" prop="payee">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_1757265828501258200" :value="scope.row.payee" />
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip label="金融机构" min-width="160" align="center" prop="financialInstitution">
        <template slot-scope="scope">
      ...
      <el-table-column show-overflow-tooltip label="到期提醒" min-width="120" align="center" prop="remark">
        <template slot-scope="scope">
    ...
    methods: {
      calculateValues() {
        this.form.changkouedu = (
          this.form.invoiceAmount *(1 - Number(this.form.marginLevel) / 100)
        ).toFixed(2);
