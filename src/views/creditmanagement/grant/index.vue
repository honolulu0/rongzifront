<template>
  <div class="app-container">
    ...
    <el-table :summary-method="(param) => getSummaries2(param, totalKeys, zongji)" show-summary v-loading="loading"
      ...
      <el-table-column show-overflow-tooltip label="借款人" align="left" prop="creditor" min-width="120" />
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" min-width="60%" append-to-body>
      ...
      <div v-if="created_successfully == false">
        <div v-if="title === '修改授信管理'" class="modeify-btn" style="display: flex; justify-content: end;">
  ...
  export default {
    ...
    computed: {
      ...
      remainingCreditAmount: {
        ...
        get() {
          // 确保值为数值类型，避免NaN
          const creditAmount = Number(this.form.creditAmount) || 0;
          const usedCreditAmount = Number(this.form.usedCreditAmount) || 0;
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            ...
            if (this.form.id != null) {
              ...
              data.financialInstitution = data.financialInstitution.join(',')
              this.rzaudit_data = {
                "auditId": data.id,
