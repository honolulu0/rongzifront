<template>
  <div class="app-container">
    ...
    <el-table :summary-method="(param) => getSummaries2(param, totalKeys, zongjia)" show-summary v-loading="loading"
      ...
      <!-- <el-table-column label="担保合同编号" align="left" prop="contractId" /> -->
      ...
      <!-- <el-table-column show-overflow-tooltip label="担保类别" align="left" prop="guarantor" min-width="100"> -->
      <!-- <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_1767155091485229000" :value="scope.row.guarantor" />
        </template> -->
      <!-- </el-table-column> -->
      ...
      <el-table-column show-overflow-tooltip label="是否上征信" align="left" prop="isCreditInvestigation" min-width="100">
        <template slot-scope="scope">
      ...
      <el-table-column show-overflow-tooltip label="担保比例" align="left" prop="guaranteeRatio" />
       -->
      <el-table-column show-overflow-tooltip label="操作" fixed="right" align="left" class-name="''">
        <template slot-scope="scope">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              <el-form-item label="担保比例" prop="guaranteeRatio">
                ...
                <tiny-numeric class="w" show-left :controls="false" size="small" v-model="form.guaranteeRatio"
                  :empty-value="0" :format="{
