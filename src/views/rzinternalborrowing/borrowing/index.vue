<template>
  <div class="app-container">
    ...
    <el-table :summary-method="(param) => getSummaries2(param, totalKeys, zongji)" show-summary
      ...
      <el-table-column show-overflow-tooltip label="还款方式" align="center" prop="repaymentMethod" min-width="80">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_1759501742422098000" :value="scope.row.repaymentMethod" />
        </template>
      </el-table-column>
      <el-table-column show-overflow-tooltip label="借款用途" align="center" prop="loanUse" min-width="160">
        <template slot-scope="scope">
      ...
      <div v-if="created_successfully == false">
        ...
        <el-form ref="form" :model="form" label-position="top" :rules="rules" label-width="80px">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="管理编号" prop="managementId">
                <el-input :readonly="title === '修改内部借款'" v-model="form.managementId" placeholder="请输入管理编号" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="借款金额（万元）" prop="loanAmount">
