<template>
  <div class="app-container">
    ...
    <el-table :summary-method="(param) => getSummaries2(param, totalKeys, zongjia)" show-summary v-loading="loading"
      ...
      <el-table-column show-overflow-tooltip label="出借人" align="left" prop="payee" min-width="130">
        <template slot-scope="scope">
      ...
      <el-table-column show-overflow-tooltip label="借款期限" align="left" prop="loanTerm" min-width="100">
        <template slot-scope="scope">
      ...
      <el-table-column label="还款方式" align="left" prop="repaymentMethod">
        <template slot-scope="scope">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="管理编号" prop="managementId">
                <el-input :readonly="title === '修改专项借款'" v-model="form.managementId" placeholder="管理编号" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="借款金额（万元）" prop="loanAmount">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="余额（万元）" prop="balance">
                <el-input-number :disabled="!isEditable" class="w" :controls="false" :precision="2"
                  :readonly="!isEditable" type="number" v-model.trim="remainingCreditAmount" placeholder="余额" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="借款人" prop="borrower">
            ...
            <el-col :span="8">
              <el-form-item label="起始日" prop="loanDate">
                <el-date-picker format='yyyy/MM/dd' :disabled="!isEditable" clearable v-model="form.loanDate"
                  type="date" value-format="yyyy-MM-dd" placeholder="请选择起始日"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          repaymentMethod: [{
            required: true,
            message: "还款方式：先息后本不能为空",
            trigger: "change"
          }],
          loanUse: [{
            required: true,
            message: "业务类型：保交楼、城中村改造不能为空",
            trigger: "change"
          }]
        }
      };
