  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="信息名称" prop="dictType">
        <el-select filterable v-model="queryParams.dictType" @change="dictTypeChange">
  ...
  export default {
    ...
    methods: {
      ...
      handleQuery() {
        ...
        this.queryParams.dictName = this.typeOptions.find(option => option.dictType === this.queryParams.dictType).dictName;
        this.getList();
      },
      /** 返回按钮操作 */
      handleClose() {
