    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <span slot="label">
            生成包路径
            <el-tooltip content="生成在哪个java包下，例如 com.rongzi.system" placement="top">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        packageName: [
          { required: true, message: "生成包路径", trigger: "blur" }
        ],
        moduleName: [
          { required: true, message: "生成模块名", trigger: "blur" }
        ],
        businessName: [
          { required: true, message: "生成业务名", trigger: "blur" }
        ],
        functionName: [
          { required: true, message: "生成功能名", trigger: "blur" }
        ],
      }
    };
  },
