  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="表名称" prop="tableName">
        <el-input v-model="queryParams.tableName" placeholder="表名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="表描述" prop="tableComment">
        <el-input v-model="queryParams.tableComment" placeholder="表描述" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="创建时间">
        <el-date-picker format='yyyy/MM/dd' v-model="dateRange" style="width: 240px" value-format="yyyy-MM-dd"
    ...
    methods: {
      ...
      handleGenTable(row) {
        ...
        if (row.genType === "1") {
          ...
          this.$download.zip("/tool/gen/batchGenCode?tables=" + tableNames, "rongzi.zip");
        }
      },
      /** 同步数据库操作 */
      handleSynchDb(row) {
